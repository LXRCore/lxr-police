...
RegisterNetEvent('police:client:spawnCone', function()
    exports['lxr-core']:Progressbar("spawn_object", Lang:t("progressbar.place_object"), 2500, false, true, {
...
RegisterNetEvent('police:client:deleteObject', function()
    ...
    if dist < 5.0 then
        exports['lxr-core']:Progressbar("remove_object", Lang:t('progressbar.remove_object'), 2500, false, true, {
            disableMovement = true,
            disableCarMovement = true,
            disableMouse = false,
            disableCombat = true,

...
AddEventHandler('LXRCore:Client:OnPlayerLoaded', function()
    local player = exports['lxr-core']:GetPlayerData()
    PlayerJob = player.job
    onDuty = player.job.onduty
    isHandcuffed = false

    TriggerServerEvent("LXRCore:Server:SetMetaData", "ishandcuffed", false)
...
RegisterNetEvent('police:client:policeAlert', function(coords, text)
    exports['lxr-core']:Notify(9, {text = text, caption = street1name.. ' ' ..street2name}, 'police')
    local transG = 250
